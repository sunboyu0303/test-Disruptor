...
public class Demo1 {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        final RingBuffer<TradeTransaction> ringBuffer = RingBuffer.createSingleProducer(
                eventFactory, BUFFER_SIZE, new YieldingWaitStrategy());
        ...
        //创建消息处理器
        BatchEventProcessor<TradeTransaction> batchEventProcessor = new BatchEventProcessor<TradeTransaction>(
